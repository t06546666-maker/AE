...
export function Customers({ user }: { user: UserProfile }) {
  ...
  const remove = useMutation({
    ...
    onSuccess() { showToast(t('customers.deleted')); void queryClient.invalidateQueries({ queryKey: ['customers'] }); void queryClient.invalidateQueries({ queryKey: ['orders'] }); void queryClient.invalidateQueries({ queryKey: ['dashboard'] }); },
