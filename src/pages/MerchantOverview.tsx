...
export function MerchantOverview({ user }: { user: UserProfile }) {
  ...
  return <div className="merchant-overview">
    ...
    {view === 'overview' && <>
      ...
      <Link to="/rewards" className="mo-scan-action"><span className="mo-scan-icon"><BarChart3 size={22} /></span><span><strong>Scan customer QR</strong><small>Record a purchase or redeem points</small></span><ChevronRight size={20} /></Link>
